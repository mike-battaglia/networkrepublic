			...
			<div class="swp-flex--col swp-flex--wrap swp-flex--gap-md">
				<div class="swp-flex--row swp-items-stretch swp-flex--gap-md">
					...
					<?php if ( ! empty( $form['search-button'] ) ) : ?>
						<button type="submit" class="search-submit swp-button" id="nr-search-button">
							<img src="/wp-content/uploads/2023/12/searc-icon-white.svg" alt="Search" id="nr-search-icon" class=""/>
						</button>
